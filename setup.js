...
class Database{
  ...
  static contactTable() {
    var db = this.db()
    db.run('CREATE TABLE IF NOT EXISTS contacts (id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(20), company VARCHAR(20), phone_number VARCHAR(20), email VARCHAR(20))')
  }
